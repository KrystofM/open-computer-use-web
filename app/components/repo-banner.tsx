...
const REPO_URL = 'https://github.com/KrystofM/open-computer-use-web'
...
export function RepoBanner({ className }: { className?: string }) {
  return (
    <a
      ...
      aria-label={`View Computer Use repository on GitHub`}
      className={cn(
        'bg-white overflow-hidden px-3 py-1 rounded-t-2xl',
